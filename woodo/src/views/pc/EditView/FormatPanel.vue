<template>
    ...
    >
        ...
        <div class="format-contain" v-if="show_format_panel && element_type" @click="hide_all_list()">
            <div class="format-header">
                ...
                <button class="close" @click="toggleFormatPanel()">
                    <base-icon class="iconguanbi2"></base-icon>
                </button>
            </div>
            <div class="format-main" v-if="!show_clip_ratio">
                ...
                <div class="style-module" v-if="'style' in formatTypeStatus">
                    ...
                    <div class="content" v-show="formatTypeStatus.style">
                        <!-- 字体 -->
                        <div class="font-family" :class="{ 'un-able': element_type === 'chart'}">
                                ...
                                <div class="ul-menu-btn" @click="text_list_panel_show = text_list_panel_show === 'ul' ? null : 'ul'">
                                    ...
                                    <div class="menu-list" v-show="text_list_panel_show === 'ul'">
                                        ...
                                        <div class="item-list">
                                            ...
                                            <div class="item" :class="{current: element_message.ul === item.data}" @click="set_font_orderedList('insertUnorderedList', item.data)" v-for="(item,index) in text_unordered_list" :key="index">
                                                <base-icon :class="item.icon"></base-icon>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="ol-menu-btn" @click="text_list_panel_show = text_list_panel_show === 'ol' ? null : 'ol'">
                                    ...
                                    <div class="menu-list" v-show="text_list_panel_show === 'ol'">
                                        ...
                                        <div class="item-list">
                                            ...
                                            <div class="item" :class="{current: element_message.ol === item.data}" @click="set_font_orderedList('insertOrderedList', item.data)" v-for="(item,index) in text_ordered_list" :key="index">
                                                <base-icon :class="item.icon"></base-icon>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="text-range">
                            <div class="letter-space">
                                ...
                                <base-unit-input
                                    ...
                                    @add="set_font_spacing(+element_message.letter_spacing + 1)"
                                    @cut="set_font_spacing(+element_message.letter_spacing - 1)">
                                </base-unit-input>
                            </div>
                            <div class="line-height">
                                ...
                                <base-unit-input
                                    ...
                                    @add="set_font_lineHeight(+element_message.line_height + 1)"
                                    @cut="set_font_lineHeight(+element_message.line_height - 1)">
                                </base-unit-input>
                            </div>
                        </div>
                         <!-- 艺术字相关设置 -->
                        <div class="art-text-module" v-if="element_message.text_type === 'art'">
                            <template v-if="show_art_text_seeting && !element_message.disable_setting">
                                <!-- 艺术字背景图尺寸 -->
                        ...
                        <transition name="modal-fade">
                            <div class="shadow-panel" v-if="element_message.shadow&&element_message.shadow.open">
                                ...
                                <div class="shadow-group" v-if="element_message.shadow">
                                    <knob :max="360" v-model="element_message.shadow.rotate" @mousemove="set_ele_shadow(element_message.shadow.rotate,'rotate')"></knob>
        ...
        <div class="convformat_contain" :style="{ visibility: element_type !== '' && !show_format_panel ? '' : 'hidden'}">
            ...
            <div class="tools-panel" v-if="!show_clip_ratio && !show_audio_controls && !show_format_panel" @click.stop>
                ...
                <button class="tailor-img"  v-if="element_type === 'img'"
                    ...
                    <base-icon class="iconcaijian1"></base-icon>
                </button>
                <!-- 字体 -->
                ...
                <div class="border_panel" v-if="tools_border">
                    <button class="border-btn" v-tooltip="`边框`"
                        ...
                        <base-icon class="iconwutianchongmiaobian"></base-icon>
                    </button>
                ...
                <div class="ele_align_panel" v-if="tools_ele_align">
                    <button class="ele-align-btn"
                        ...
                        v-tooltip="`画布对齐`">
                        <base-icon class="iconzuoduiqi"></base-icon>
                    </button>
        ...
        <!-- 字体 -->
         <transition name="modal-fade">
            <div class="font-family-list" ref="text_family" v-if="pull_list_type === 'text_family'">
                <div class="font-family-header">
                    ...
                    <button class="font-family-btn" 
                        ...
                        @click.stop="select_family_lang('family', index)" 
                    ...
                    <!-- 艺术字 -->
                    <button class="font-family-btn" :class="{'current': text_family_list_show === 'art'}" @click.stop="select_family_lang('art')">
                        <span>艺术字</span>
                    </button>
                </div>
    ...
    export default{
        ...
        data(){
            return {
                ...
                show_art_text_seeting: true,                              // 艺术字设置展示标识
                art_text_style: {},
                ...
                text_unordered_list:[
                    {name: "", icon:'iconwuxudayuandian', data: "disc"},
                    {name: "", icon:'iconwuxufangxing', data: "square"},
                    {name: "", icon:'iconwuxulingxing', data: "diamond"},
                    {name: "", icon:'iconkongfangxing', data: "square-box"},
                    {name: "", icon:'iconwuxuxuanzhong', data: "hook"},
                    {name: "", icon:'iconwuxujiantou', data: "arrow"},
                    {name: "", icon:'iconwuxuxiaoyuandian', data: "spot"},
                ],
                text_ordered_list:[
                    {name: "", icon:'icon123', data: "decimal"},
                    {name: "", icon:'iconyiersan', data: "cjk-ideographic"},
                    {name: "", icon:'iconABC1', data: "upper-latin"},
                    {name: "", icon:'iconABC', data: "lower-latin"},
                    {name: "", icon:'iconIII', data: "upper-roman"},
                ],
        ...
        methods:{
            ...
            set_ele_border_width: function(data){
                ...
                let color_history = localStorage.getItem("color_history") ? localStorage.getItem("color_history").split(",") : [];
            ...
            set_format_painter:function(stay){
                ...
                that.$parent.format_painter_style = format_style;
                that.$parent.stay_format_painter = stay;
                that.$parent.had_format_painter = true;
            },
            // 设置字间距
            set_font_spacing: function(data){
                ...
                operate_opt.reset_rect($checked);
                // 刷新元素对象数据
                that.$parent.element_message.letter_spacing = data;
            },
            // 设置文本颜色
            ...
            change_text_art: function(item){
                ...
                that.$parent.element_message = option.get_edit_message($checked);
            ...
            */
            // 控制艺术字设置展示或隐藏
            toggle_art_text_setting(){
                this.show_art_text_seeting = !this.show_art_text_seeting;
            },
