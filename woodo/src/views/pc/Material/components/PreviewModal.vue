<template>
    <base-modal class="design-preview-modal" ref="preview" @close="close()">
        <template #custom>
            <div class="preview-wrapper">
                ...
                <div class="preview-main">
                    ...
                    <template v-else>
                        ...
                        <!-- 内容模块 -->
                        <div class="play-box">
                            <!-- <p>{{ previewType === 'template' ? previewInfo.name : previewInfo.properties.resolution }}</p> -->
                        ...
                        <div class="info-box">
                            <p>
                                ...
                                <template v-else-if="previewType !== 'template'">
                ...
                <div class="recommend-main">
                    <h2>相似推荐</h2>
                    <span class="more" @click="skipMore()">查看全部</span>
                    <design-list v-if="previewInfo" customClick isRecommend :design-type="previewType" :category="previewInfo.category.code" @click="changePreview"></design-list>
                </div>
            </div>
        </template>
    </base-modal>
...
export default {
    ...
    methods: {
        ...
        close() {
            ...
            window.history.pushState(null, null, this.defaultUrl);
            this.$emit('close');
        },
        // 获取模板详情
        getTemplateDetail() {
            this.designMixinGetDetail(this.previewType, this.previewId).then(info => {
                ...
                window.history.pushState(null, null, `${location.origin}/design/${this.previewType}/${this.previewInfo.id}`);
            });
        },
        // 获取素材详情
        getMaterialDetail() {
        ...
        skipMore() {
            if (this.$route.params.type) {
                ...
                this.$router.push({path: `/design/${this.previewType}`})
            }
        },
        // （取消）收藏
        favorite() {
