        ...
        <div class="contain_wrapper" ref="scroll_contain" :style="{'overflow-y': fullScreen ? 'hidden' : 'auto'}">
            ...
            <div class="slides_container">
                ...
                <div class="slides_wrapper">
                    ...
                    <!-- 作品信息 全屏需隐藏 -->
                    <div class="work_info_panel" v-show="!fullScreen">
                        <div class="wrapper" :style="{'width': `${svg_w}px`}">
                            ...
                            <div class="panel_right">
                                ...
                                <button class="collect_btn" 
                                        v-tooltip.top="is_favorite ? '取消收藏' : '收藏'" 
                                        :class="{collected:is_favorite}" 
                                        @click="document_favorite"
                                        v-bdtongji="`共享作品-预览页-作品预览区-中部-收藏`"></button>
                ...
                <div class="wrapper">
                    ...
                    <div class="related_works_panel">
                        <div class="header">
                            ...
                            <a class="more" href="/work_share/">更多></a>
                        </div>
                        <div class="works_list">
                            <works_card v-for="(item,index) in hot_works_list" :key="index" :works_info="item" :favorite_map="favorite_map_arr"></works_card>
                            <!-- 占位 -->
                            <works_card v-for="s_item in 4" :key="s_item" card_class="placeholder"></works_card>
                        </div>
                    </div>
                </div>
            </div>
...
import works_card from '@/views/pc/Material/components/WorksShareCard.vue';
