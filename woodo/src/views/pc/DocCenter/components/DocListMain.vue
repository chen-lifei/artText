...
<script>
    ...
    import DocListCard from '@/views/pc/DocCenter/components/DocListCard.vue';
    import DocTileCard from '@/views/pc/DocCenter/components/DocTileCard.vue';
...
.doc-list-main{
        ...
        .sort-bar{
            ...
            .sort-display{
                ...
                &::after{
                    ...
                    border-bottom: 4px solid #767684;
                    transform: rotate(180deg);
                    transition: all 0.3s;
                }
            }
            &.show .sort-display::after{
    ...
    .main-body{
        ...
        .drag-holder{
            background: #edeff3;
            border: 1px dashed #767684;
            border-radius: 7px;
            /deep/ .card-wrap > *{
                display: none;
            }
        }
        .dustbin-card:not(.batch){
		...
		.doc-empty{
			...
			&::before{
				...
				width: 100%;
				height: 250px;
				background: url(~@/assets/common/images/empty.png) no-repeat top center;
