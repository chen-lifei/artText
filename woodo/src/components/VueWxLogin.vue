<template>
  <div>
    <iframe id="wx_login" scrolling="no" width="160" height="160" frameBorder="0" allowTransparency="true" :src="setSrc"></iframe>
  </div>
</template>
...
<script>
    export default {
        ...
        props:{
            ...
            href : {
                type : String,
                default: 'https://wubaiding.bj.bcebos.com/resouces/css/weixin_qrcode.css'
            },
        },
    }
</script>
