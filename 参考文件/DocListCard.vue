    ...
    >
        <div class="card-wrap flex flex-between">
            ...
            <div class="card-left flex">
                ...
                <!-- 文档图标 -->
                <img :src="require(`../../../assets/pc/images/doc/${docIcon}-list-icon.png`)">
            ...
            docOwner() {
                ...
                switch (true) {
                    ...
                    case !!doc.grade:
                        result = '由我创建';
                        if (type === 'myTeam') {
                            result = `由${ doc.member.id == this.$common.get_cookies('woodo_memberId') ? '我' : (doc.member.nickName || doc.member.id) }创建`;
                        }
                        break;
                    default:
...
.draggingStyle{
    ...
    opacity: .6;
    &[data-type=folder]{
        background: url(~@/assets/pc/images/doc/folder-list-icon.png) no-repeat;
    }
    &[data-type=slide]{
        background: url(~@/assets/pc/images/doc/slide-list-icon.png) no-repeat;
    }
    &[data-type=design]{
        background: url(~@/assets/pc/images/doc/design-list-icon.png) no-repeat;
    }
    .card-wrap{
        display: none;
    }
